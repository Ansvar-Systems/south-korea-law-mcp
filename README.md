...
**Endpoint:** `https://mcp.ansvar.eu/law-kr/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add south-korea-law --transport http https://mcp.ansvar.eu/law-kr/mcp` |
...
```json
{
  "mcpServers": {
    "south-korea-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-kr/mcp"
    }
  }
}
```
