...
const SERVER_NAME = 'south-korea-law-mcp';
...
const GITHUB_REPO = 'Ansvar-Systems/south-korea-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.SOUTH_KOREA_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.SOUTH_KOREA_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
