...
/**
 * South Korea Law MCP Server — stdio entry point.
 *
 * Provides South Korean legislation search via Model Context Protocol.
 */
...
const DB_ENV_VAR = 'SOUTH_KOREA_LAW_DB_PATH';
