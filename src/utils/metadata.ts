/**
 * Response metadata for South Korea Law MCP tool responses.
 */
...
export function generateResponseMetadata(
  ...
  return {
    ...
    disclaimer:
      'This data is derived from the Korean Law Information Center (law.go.kr) and KLRI English translations. ' +
      'The Korean text is the sole legally binding version. ' +
      'Verify against official publications when legal certainty is required.',
    source_authority: 'Ministry of Government Legislation (법제처), Republic of Korea',
  };
}
